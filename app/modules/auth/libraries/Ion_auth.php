...
//        $modules = $this->administration_mod->load_modules();
        ...
        if ($this->logged_in()) {
            ...
            define("LAST_NAME", $user->last_name);
            define("USER_NAME", $user->first_name);
            define("USER_ID", $user->id);
            define("EPF_NO", $user->epf_no);
            define("COMPANY_NAME", $this->administration_mod->setting('company_name'));
            define("COMPANY_ADDRESS", $this->administration_mod->setting('company_address'));
            ...
            define("WORK_HOURS", $this->administration_mod->setting('work_hours'));
            define("HALF_WORK_HOURS", $this->administration_mod->setting('work_hours_half'));
            define("HALF_WORK_STEND", $this->administration_mod->setting('halfday_time_mo_end'));
            define("START_TIME", $this->administration_mod->setting('start_time'));
            define("END_TIME", $this->administration_mod->setting('end_time'));
            define("LATE_LA", $this->administration_mod->setting('late_time_LA'));
            define("LATE_EL", $this->administration_mod->setting('late_time_EL'));
            define("HALF_D_TIME_MO", $this->administration_mod->setting('halfday_time_mo'));
            define("HALF_D_TIME_EV", $this->administration_mod->setting('halfday_time_ev'));

            //holiday halfday settings
            define("holiday_morning_end", $this->administration_mod->setting('holiday_morning_end'));
            define("holiday_morning_er_late", $this->administration_mod->setting('holiday_morning_er_late'));
            define("holiday_evening_start", $this->administration_mod->setting('holiday_evening_start'));
            define("holiday_evening_late", $this->administration_mod->setting('holiday_evening_late'));

            define("PAY_MONTHLY", $this->administration_mod->setting('monthly'));
            define("PAY_FROM_DAY", $this->administration_mod->setting('from_day'));
            define("PAY_UPTO_DAY", $this->administration_mod->setting('upto_day'));
            define("MAX_LEAVE", $this->administration_mod->setting('max_leave'));

            define("PROJECTS", $this->administration_mod->modules("PROJECTS"));

            //added by kasun for employee name @@@####
            define("EMPNAME","initials,' ',last_name");
//            define("EMPNAME",`full_name`,' ');
            //added by kasun for employee name @@@####
