    ...
    <table style="font-family:Verdana,sans-serif;font-size:11px;color:#374953;width:550px">
        ...
        <tr>
            <td style="font-size:12px;font-weight:bold;padding:0.5em 1em" align="left">
                Hi <?php echo $employee_first_name;?>,<br>
                Your Leave Application (No.<?php echo $leave_application_id ?>) has been successfully forwarded to the
                <?php echo $sup_first_name; ?>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
