    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Employee List View</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        ...
        <div class="element-wrapper">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Employee List View</h4>
                <!-- <?php

                 $this->load->library('kcrud');
                 $auth = $this->kcrud->getValueOne("auth_users_button_permission","id,button,user_id","WHERE user_id=".USER_ID." AND button=1",null,null,null,null);
                ...
                <div class="row">
                    <div class="col-md-12" style="">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item"><a class="nav-link active" role="tab" href="#basic_info" data-toggle="tab"> EMPLOYEE INFORMATION </a></li>
                            <li class="nav-item"><a class="nav-link" role="tab" href="#usage_info" data-toggle="tab"> USAGE INFORMATION </a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane p-20 active" role="tabpanel" id="basic_info">
                                <div class="card-body" style="margin-top: 20px">
                                    <h5 class="form-title" style="display: block; background: #838c94;color: #fff; padding: 3px 5px;">Employee Information</h5>
                                    <div class="row">
                                        <div class="col-md-3 col-xs-6 b-r"><strong class="text-muted">Employee Code</strong>
                                            <br>
                                            <h6 id="emp_view_emp_code"  class="text-info-hr"></h6>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"><strong class="text-muted">Full Name</strong>
                                            <br>
                                            <h6 id="emp_view_fullname"  class="text-info-hr"></h6>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"><strong class="text-muted">Designation</strong>
                                            <br>
                                            <h6 id="emp_view_designation"  class="text-info-hr"></h6>
                                        </div>
                                        <div class="col-md-3 col-xs-6"><strong class="text-muted">Division</strong>
                                            <br>
                                            <h6 id="emp_view_division"  class="text-info-hr"></h6>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-3 col-xs-6 b-r"><strong class="text-muted">Organization</strong>
                                            <br>
                                            <h6 id="emp_view_organization"  class="text-info-hr"></h6>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"><strong class="text-muted">Employee Scheme</strong>
                                            <br>
                                            <h6 id="emp_view_scheme"  class="text-info-hr"></h6>
                                        </div>
                                    </div>
                                    <hr>
                                    <div id="family_info" style="margin-top: 20px">

                                    </div>
                                </div>
                            </div>

                            <div class="tab-pane p-20" role="tabpanel" id="usage_info">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="element-wrapper">
                                                ...
                                                <div class="card-header bg-info">
                                                    <h4 class="card-title text-white" style="display: inline-block"> USAGE CHART</h4>
                                                </div>
                                                <div class="element-box">
                                                    <div class="m-widget4" style="height:200px;">
                                        ...
                                        <div class="col-md-6" >
                                            <div class="element-wrapper">
                                                ...
                                                <div class="card-header bg-info">
                                                    <h4 class="card-title  text-white" style="display: inline-block"> USAGE INFO</h4>
                                                </div>
                                                <div class="element-box" style="height: 200px">
                                                    <div class="col-md-10" id="claim_details" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script src="<?php echo base_url(); ?>assets/global/scripts/chart.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/global/scripts/chart.PieceLabel.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/global/scripts/jquery.mask.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/global/scripts/material-charts.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        employee_table = $('#employee_datatable').DataTable({
            ...
            "ajax": {
                ...
                "url": "<?php echo base_url()?>index.php/employee/employee_listing/employee_list",
                "type": "POST"
            },
        ...
        $.ajax({
            async: false,
            url: "<?php echo site_url('index.php/employee/employee_listing/get_master_data'); ?>",
            type: "POST",
            data: {
                "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash() ?>"
            },
    ...
    //     $('.error-block').empty();
    //     $.ajax({
    //         url : "<?php echo site_url('index.php/employee/employee_listing/edit_employee/')?>/" + id,
    //         type: "POST",
    //         "data": {
    //             "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"
    //         },
    ...
    function usage_emp(id)
    {

        save_method = 'update';
        $('.error-block').empty();
        $.ajax({
            url : "<?php echo site_url('index.php/employee/employee_listing/usage_employee')?>/" + id,
            type: "POST",
            "data": {
                "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"
            },
            ...
            success: function(data)
            {
                ...
                $('#emp_view_emp_code').html(data.employee.emp_code);
                $('#emp_view_fullname').html(data.employee.title+'. '+data.employee.initials+' '+data.employee.name);
                $('#emp_view_designation').html(data.employee.designation_name);
                $('#emp_view_division').html(data.employee.division_name);
                $('#emp_view_organization').html(data.employee.organization_name);
                $('#emp_view_scheme').html(data.employee.emp_scheme)
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            label: data.usageLabels,
                            data: data.usageAmount,
                            backgroundColor: ['#00e5ff','#b80032'],
                            borderColor: ['#00e5ff','#b80032'],
                            borderWidth: 1
                        }]
                    },
                    options: {
                ...
                $("#claim_details").html('' +
                    '<div style="text-align:center;background-color: #0c8841;color: white;border-radius: 10px;height: 60px !important;width: 200px !important;"><br>&nbsp;&nbsp;LIMIT '+data.emp_limit+'&nbsp;&nbsp;</div>&nbsp;&nbsp;' +
                    '<div style="text-align:center;background-color: #067088;color: white;border-radius: 10px;height: 60px !important;width: 200px !important;"><br>&nbsp;&nbsp;BALANCE '+data.emp_balance+'&nbsp;&nbsp;</div>&nbsp;&nbsp;' +
                    '<div style="text-align:center;background-color: #b60016;color: white;border-radius: 10px;height: 60px !important;width: 200px !important;"><br>&nbsp;&nbsp;USED '+data.emp_used+'&nbsp;&nbsp;</div>' +
                    '');
                ...
                if(data.family_info){
                    ...
                    for(var i= 0; i< data.family_info.length; ++i){
                        ...
                        html_data += '<tr>'+
                            ...
                            '</td>' +
                            '<td style="width:300px !important;">' +
                            ''+data.family_info[i].member+'' +
                            '</td>' +
                            '<td>' +
                            ''+data.family_info[i].status+''+
                            '</td>'+
                            '</tr>';

                    }
                    html_data +='</table>';
                    $("#family_info").html(html_data);
                }

                $('#emp_view_modal').modal({backdrop: 'static', keyboard: false});
                $('#emp_view_modal .modal-title').text('View Employee Usage : #' + data.employee.initials+" "+data.employee.name);
            },
            error: function ()
            {
                console.log('Error get Edit EMP Data');
...
//                    window.location = "<?php //echo base_url('systems/employee_list/index')?>//";
    ...
    {
        var url = "<?php echo site_url('index.php/employee/employee_listing/save_employee'); ?>/" + save_method;
        $.ajax({
            url: url,
            type: "POST",
