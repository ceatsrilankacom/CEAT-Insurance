...
class Sales_itinerary_sales_manager extends CI_Controller
{
    ...
    public function get_all_itinerary()
    {
        ...
        $this->datatables->add_column("Actions",
            "<a class='btn btn-sm btn-default tbl-action' target='_blank' href='".base_url('index.php/insurance/sales_itinerary/sales_itinerary_redirect/$1/$2/SM')."' title='Edit Sales Itinerary'>
