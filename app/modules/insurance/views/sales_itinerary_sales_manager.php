...
function search_credit(){
    ...
    $.ajax({
        ...
        url:"<?php echo base_url('index.php/insurance/sales_itinerary/get_credit_limit'); ?>",
        dataType:"JSON",
        type:"POST",
...
function save(){
    ...
    $("#loading_modal").modal({backdrop: 'static', keyboard: false});
    var url="<?php echo base_url('index.php/insurance/sales_itinerary/save'); ?>";
...
function edit_save(){
    ...
    $("#loading_modal").modal({backdrop: 'static', keyboard: false});
    var url="<?php echo base_url('index.php/insurance/sales_itinerary/edit_save'); ?>";
...
<script>
    ...
    function edit_itinerary(id){
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('index.php/insurance/sales_itinerary/edit_itinerary'); ?>/"+id,
            type: "POST",
            dataType: "JSON",
            data:{
                '<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>'
    ...
    function approve_itinerary(rep_id,ref_month){
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('index.php/insurance/sales_itinerary/edit_itinerary'); ?>/"+rep_id+"/"+ref_month,
            type: "POST",
            dataType: "JSON",
            data:{
                '<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>'
    ...
    $.ajax({
        async: false,
        url: "<?php echo site_url('index.php/insurance/sales_itinerary/get_work_flow_status'); ?>",
        type: "POST",
        data: {
            "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash() ?>"
        },
