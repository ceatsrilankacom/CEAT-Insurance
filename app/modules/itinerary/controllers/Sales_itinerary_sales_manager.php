...
class Sales_itinerary_sales_manager extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $title="Sales Itinerary - Sales Manager";
        $meta["title"]=$title;
        $data["title"]=$title;
        ...
        $this->load->view('sales_itinerary_sales_manager', $data);
    ...
    public function get_all_itinerary()
    {
        ...
        $this->datatables->where(array('tbl_sales_itinerary.sales_staff'=>'Approved'));
        ...
        $this->datatables->add_column("Actions",
            "<a class='btn btn-sm btn-default tbl-action' target='_blank' href='".base_url('index.php/itinerary/sales_itinerary/sales_itinerary_redirect/$1/$2/SM')."' title='Edit Sales Itinerary'>
