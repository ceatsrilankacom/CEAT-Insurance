    ...
    $(document).ready(function(){
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            select:function(start, end, allDay)
            {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url('index.php/itinerary/sales_itinerary_calendar/get_itinerary_info/'.$rep_id); ?>",
                    type: "POST",
                    dataType: "JSON",
                    data:{
        ...
        $("#btn_save_sys").on('click',function(){
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('index.php/itinerary/sales_itinerary_calendar/save'); ?>",
                type: "POST",
                dataType: "JSON",
...
<script>
    ...
    function edit_itinerary(){
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('index.php/itinerary/sales_itinerary/edit_enable_itinerary'); ?>",
            type: "POST",
            dataType: "JSON",
            data:{
                '<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>'
    ...
    function edit_disable_itinerary(){
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('index.php/itinerary/sales_itinerary/edit_disable_itinerary'); ?>",
            type: "POST",
            dataType: "JSON",
            data:{
                '<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>'
