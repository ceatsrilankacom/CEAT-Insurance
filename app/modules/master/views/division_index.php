    ...
    <div class="col-12">
        <div class="element-wrapper">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Master - Division</h4>
                        ...
                        $(document).ready(function(){
                            ...
                            masterInfo = $('#masterInfo').DataTable({
                                ...
                                "ajax":{
                                    ...
                                    "url": "<?php echo base_url()?>index.php/master/master_con/get_master_division",
                                    "type": "POST"
                                },
                                "columnDefs": [
                                    {
                    ...
                    <script>
                        ...
                        function edit_master(id){
                            ...
                            $.ajax({
                                ...
                                url:"<?php echo base_url('index.php/master/master_con/get_division/'); ?>"+id,
                                dataType:"JSON",
                                type:"POST",
                                data:{
                                    "<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"
                        ...
                        function save(){
                            ...
                            if(save_method == "add"){
                                url="<?php echo base_url('index.php/master/master_con/save_division'); ?>";
                            }
                            else if(save_method == "edit"){
                                url="<?php echo base_url('index.php/master/master_con/edit_division'); ?>";
                            }
