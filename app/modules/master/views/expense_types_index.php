...
<div class="card-header bg-info page-head-title-wrap">
    <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Master - Expense Types</h4>
    ...
    $(document).ready(function(){
        ...
        masterInfo = $('#masterInfo').DataTable({
            ...
            "ajax":{
                ...
                "url": "<?php echo base_url()?>index.php/master/master_con/get_master_expense_types",
                "type": "POST"
            },
            "columnDefs": [
                {
