...
<div class="card-header bg-info page-head-title-wrap">
    <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Master - Holidays</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="control-label col-md-4" for="code" style='text-align: right;color:black;'><b>Holiday Name</b></label>
                                    <div class="col-md-6">
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-md-4" for="name" style='text-align: right;color:black;'><b>Date</b></label>
                                    <div class="col-md-6">
    ...
    $(document).ready(function(){
        ...
        masterInfo = $('#masterInfo').DataTable({
            ...
            "ajax":{
                ...
                "url": "<?php echo base_url()?>index.php/master/master_holidays/get_master_holidays",
                "type": "POST"
            },
            "columnDefs": [
                {
...
<script>
    ...
    function edit_master(id){
        ...
        $.ajax({
            ...
            url:"<?php echo base_url('index.php/master/master_holidays/get_expense_type/'); ?>"+id,
            dataType:"JSON",
            type:"POST",
            data:{
                "<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"
            ...
            success:function(data){
                ...
                $('[name="id"]').val(id);
                $('[name="date"]').val(data.master_data.date);
    ...
    function save(){
        ...
        if(save_method == "add"){
            url="<?php echo base_url('index.php/master/master_holidays/save_expense'); ?>";
        }
        else if(save_method == "edit"){
            url="<?php echo base_url('index.php/master/master_holidays/edit_expense'); ?>";
        }
