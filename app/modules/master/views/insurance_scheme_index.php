    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Insurance Scheme</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="element-wrapper">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Master - Insurance Scheme</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-4" for="name" style='text-align: right;color:black;'><b>Scheme Code</b></label>
                                                        <div class="col-md-6">
                                                            <input type="text" name="scheme_code" id="scheme_code" class="form-control" placeholder="Name">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-4" for="name" style='text-align: right;color:black;'><b>Scheme Code</b></label>
                                                        <div class="col-md-6">
                                                            <input type="text" name="max_amount" id="max_amount" class="form-control numeric" placeholder="0.00">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        $(document).ready(function(){
                            ...
                            masterInfo = $('#masterInfo').DataTable({
                                ...
                                "ajax":{
                                    ...
                                    "url": "<?php echo base_url()?>index.php/master/master_con/get_master_insurance_scheme",
                                    "type": "POST"
                                },
                                "columnDefs": [
                                    {
                    ...
                    <script>
                        ...
                        function edit_master(id){
                            ...
                            $.ajax({
                                ...
                                url:"<?php echo base_url('index.php/master/master_con/get_insurance_scheme/'); ?>"+id,
                                dataType:"JSON",
                                type:"POST",
                                data:{
                                    "<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"
                                ...
                                success:function(data){
                                    ...
                                    $('[name="id"]').val(id);
                                    $('[name="scheme_code"]').val(data.master_data.scheme_code);
                                    $('[name="max_amount"]').val(data.master_data.max_amount);
                        ...
                        function save(){
                            ...
                            if(save_method == "add"){
                                url="<?php echo base_url('index.php/master/master_con/save_insurance_scheme'); ?>";
                            }
                            else if(save_method == "edit"){
                                url="<?php echo base_url('index.php/master/master_con/edit_insurance_scheme'); ?>";
                            }
