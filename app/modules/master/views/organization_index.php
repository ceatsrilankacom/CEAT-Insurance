...
<div class="card-header bg-info page-head-title-wrap">
    <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Master - Organization</h4>
    ...
    $(document).ready(function(){
        ...
        masterInfo = $('#masterInfo').DataTable({
            ...
            "ajax":{
                ...
                "url": "<?php echo base_url()?>index.php/master/master_con/get_master_organization",
                "type": "POST"
            },
            "columnDefs": [
                {
...
function edit_master(id){
    ...
    $.ajax({
        ...
        url:"<?php echo base_url('index.php/master/master_con/get_organization/'); ?>"+id,
        dataType:"JSON",
        type:"POST",
        data:{
            "<?php echo $this->security->get_csrf_token_name(); ?>":"<?php echo $this->security->get_csrf_hash(); ?>"
...
function save(){
    ...
    if(save_method == "add"){
        url="<?php echo base_url('index.php/master/master_con/save_organization'); ?>";
    }
    else if(save_method == "edit"){
        url="<?php echo base_url('index.php/master/master_con/edit_organization'); ?>";
    }
