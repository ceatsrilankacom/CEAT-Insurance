    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Sales Dealers</li>
            </ol>
        </div>
    </div>
</div>
...
<div class="card-header bg-info page-head-title-wrap">
    <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Master - Sales Dealers</h4>
...
<div class="tab-pane p-20 active" role="tabpanel" id="arrangement">
    <table class="table table-striped table-bordered table-hover table-header-fixed dt-responsive" id="masterInfo" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <th class="all">Distribution Channel</th>
        </tr>
        </thead>
        <tbody>
        </tbody>
    ...
    $(document).ready(function(){
        ...
        masterInfo = $('#masterInfo').DataTable({
            ...
            "ajax":{
                ...
                "url": "<?php echo base_url()?>index.php/master/master_con/get_master_sales_dealers",
                "type": "POST"
            },
            "columnDefs": [
                {
