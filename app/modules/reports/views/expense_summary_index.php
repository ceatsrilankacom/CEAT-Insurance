    ...
    <div class="col-12">
        <div class="element-wrapper">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block">Expense Summary Report</h4>
            </div>
...
<script>
    ...
    function gen_report() {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "<?php echo site_url('index.php/reports/expense_summary_report/get_expense_data');  ?>",
            data: {
