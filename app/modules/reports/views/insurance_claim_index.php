    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Insurance Bill Report</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="element-wrapper">
                            ...
                            <table class="tool" id="tools" style="position: static; visibility: visible;" border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>FROM DATE</td>
                                        <td>
                                            <input type="text" id="bill_from_date" name="bill_from_date" class="form-control date date-pick" autocomplete="off" placeholder="From Date">
                                        </td>
                                        <td>TO DATE</td>
                                        <td>
                                            <input type="text" id="bill_to_date" name="bill_to_date" class="form-control date date-pick" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="To Date">
                                        </td>
            ...
            <div class="tab-content tabcontent-border">
                <div class="tab-pane p-20 active" role="tabpanel" id="arrangement">
                    <table class="table table-striped table-bordered table-hover table-header-fixed dt-responsive" id="insuranceInfo2" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        insuranceInfo = $('#insuranceInfo2').DataTable({
                           ...
                           "serverSide": true, //Feature control DataTables' server-side processing mode.
                            ...
                            "ajax": {
                                ...
                                "data": function(d){
                                    ...
                                    d.billFromDate = $('#bill_from_date').val(),
                                    d.billToDate = $('#bill_to_date').val()
                                },
                                
                                "url": "<?php echo base_url() ?>index.php/reports/insurance_claim/get_all_claims_by_date",
                                "type": "POST",
