    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Weekly Expense Report</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="element-wrapper">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block">Weekly Expense Report</h4>
            </div>
...
<script>
    ...
    function gen_report() {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "<?php echo site_url('index.php/reports/weekly_expense_report/get_expense_data');  ?>",
            data: {
