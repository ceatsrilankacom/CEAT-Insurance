...
class Roster_con extends CI_Controller{

    public function __construct(){

        parent::__construct();
        $this->load->model('roster_mod');
    ...
    public function index(){
        ...
        $this->load->view('roster_index',$data);
    ...
    public function rosters_list(){
        ...
        hr_pay_roster_arrangement.allocation_status,
        ...
        if(USER_ID == 1){
            ...
            $this->datatables->where('hr_pay_roster_arrangement.status=0');
            $this->datatables->or_where('hr_pay_roster_arrangement.status=1');
            $this->datatables->or_where('hr_pay_roster_arrangement.status=2');
        }
            ...
            $this->datatables->where('hr_pay_roster_arrangement.status=3');
        }
            ...
            $this->datatables->where('hr_pay_roster_arrangement.status=4');
        }
            ...
            $this->datatables->where('hr_pay_roster_arrangement.status=4');
            $this->datatables->or_where('hr_pay_roster_arrangement.status=5');
        }
        else{
            $this->datatables->where('hr_pay_roster_arrangement.status=10');
        }
    ...
    public function get_master(){
        ...
        $roster=$this->kcrud->getValueAll("hr_pay_roster_arrangement","*","WHERE allocation_status=0",null,null,null,null);
    ...
    public function get_rosters(){
        ...
        $roster=$this->kcrud->getValueAll("hr_pay_roster_arrangement","id,name,description","WHERE allocation_status=1",null,null,null,null);
        ...
        if($this->form_validation->run() == false){
            ...
            if($this->kcrud->getValueOne("hr_pay_roster_arrangement","*",$where1,null,null,null,null)){
                ...
                $data=array(
                    ...
                    'C'=>$val['C'],
                    'D'=>$val['D'],
                    'first_half_day'=>$val['first_half_day'],
                    'first_half_night'=>$val['first_half_night'],
                ...
                if($insert_id=$this->kcrud->save('hr_pay_roster_arrangement',$data)){
                    ...
                    //insert roster approval table
                    $this->kcrud->save('hr_pay_roster_approval',$data3);
                    ...
                    $this->system_log->create_system_log("Roster Arrangement", "Success", "Roster arranged id #".$insert_id);
                }
                else{
                    echo json_encode(array('status'=>FALSE,'message'=>'Roster Arrangement failed !'));
                }
    ...
    public function update(){
        ...
        $this->system_log->create_system_log("Roster arrangement", "Success", "Roster arrangement updated id #".$val['arrangement_id']);
        ...
        if($this->kcrud->getValueOne("hr_pay_roster_arrangement","*","WHERE id=".$id." AND status=0",null,null,null,null)){
            ...
            if($this->kcrud->delete("hr_pay_roster_allocation",array('arrange_id'=>$id))){
                if($this->kcrud->delete("hr_pay_roster_day_off",array('ref_id'=>$id))){
                    ...
                    $this->kcrud->delete("hr_pay_roster_approval",array('roster_id'=>$id));

                    $this->system_log->create_system_log("Roster Arrangement", "Success", "Roster arrangement deleted id #".$id);
                    echo json_encode(array('status'=>TRUE,'message'=>"Roster Arrangement info deleted successfully !"));
                }
            }
        }
        else{
            echo json_encode(array('status'=>FALSE,'message'=>"No Permission To Delete !"));
        }
    ...
    public function reset_save()
    {
        ...
        if($this->kcrud->update("hr_pay_roster_arrangement",$data1,array('id'=>$val['reset_roster'],'status <='=>2))){
            ...
            $this->system_log->create_system_log("Roster Arrangement", "Success", "Roster arrangement Reset id #".$val['reset_roster']);
            ...
            echo json_encode(array('status'=>FALSE,'message'=>'No Permission to Reset!'));
    ...
    public function edit_roster($id){
        ...
        $roster=$this->kcrud->getValueOne("hr_pay_roster_arrangement","id,name,description,department,designation,month,day,night,A,B,C,D,first_half_day,first_half_night,status,created_at,updated_at,user","WHERE id=".$id,null,null,null,null);
        echo json_encode(array('roster'=>$roster));
    }
    ...
    public function change_roster(){
        ...
        $arrangement=$this->kcrud->getValueOne("hr_pay_roster_arrangement","month,status","WHERE id=".$val['arrange_id'],null,null,null,null);
        ...
        if(USER_ID == 1){
            ...
            if($arrangement->status == 1 || $arrangement->status == 2){
            }
            else{
                echo json_encode(array('status'=>FALSE,'message'=>"No Permission To Change"));
                exit();
            }
            ...
            if($arrangement->status == 4 || $arrangement->status == 5){
        ...
        $this->system_log->create_system_log("Roster Arrangement", "Success", "Roster employees adjustment #".$val['arrange_id']);
    ...
    public function allocation_save(){
        ...
        $arrangement=$this->kcrud->getValueOne("hr_pay_roster_arrangement","id,month,day,night,A,B,C,D","WHERE id=".$val['roster_allocation']." AND allocation_status=0",null,null,null,null);
...
//                            }
        ...
        $this->system_log->create_system_log("Roster Allocation", "Success", "Roster allocated id #".$val['roster_allocation']);
    ...
    public function update_day_offs(){
        ...
        if($this->kcrud->update("hr_pay_roster_day_off",$data,array('ref_id'=>$val['view_off_ref_id']))){
            $this->system_log->create_system_log("Roster Arrangement", "Success", "Roster Day offs changed id #".$val['view_off_ref_id']);
