...
// }
    ...
    public function get_all_claims_by_date()
    {
        ...
        $this->datatables->where('tbl_insurance_claims.claim_date BETWEEN "'.$val['claimFromDate'].'" AND "'.$val['claimToDate'].'"');
    ...
    public function get_all_claims_by_claimdate()
    {
        $val=$this->input->post();
        // echo $this->input->post();
        ...
        $this->datatables->select("
            ...
            tbl_employee_listing.designation,
            tbl_insurance_claims.id,
            ", FALSE);
        ...
        //$this->datatables->join('tbl_employee_listing','tbl_employee_listing.emp_code=tbl_insurance_claims.emp_code','left');
        $this->datatables->join('auth_users','auth_users.id=tbl_insurance_claims.user','left');
        $this->datatables->join('tbl_employee_listing','tbl_insurance_claims.emp_code=tbl_employee_listing.emp_code','left');
        $this->datatables->join('master_designation','tbl_employee_listing.designation=master_designation.id','left');
        // $this->datatables->add_column("Actions",
        //     "<a class='btn btn-sm btn-default tbl-action' href='javascript:void(0);' title='Edit' onclick='edit_insurance(".'$1'.")'>
        //         <i class='fa fa-edit'></i> Edit
        //     </a>","insurance_id");
