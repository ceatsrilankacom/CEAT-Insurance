...
<div class='callout callout-danger'>
    <h4>Time Card for - <?php echo $employee->first_name." ".$employee->last_name." ".$employee->employee_id ?> </h4>
    <!--<p><?php /*echo $deptt */?> -  Employees : <?php /*echo $totl->tot */?> | Present : <?php /*echo $present->pr */?> | Absence : <?php /*echo $absence->ab */?>  </p>-->
</div>
...
//            if(($work_week_data->status=="Full Day" || $work_week_data->status=="Half Day") && $state==2) {
            ...
            ?>
            <tr style="<?php if (($diff1 < $work_hours && $value['day_type'] != "Sat" || $value['work_day'] == "0.5") && (empty($value['leave_id']))) {
                echo "color: red;";
...
//                    $out_time_var = date('H:i',strtotime($value['out_time']));
                    ...
                    <input type="text" onkeyup="arrow_go('<?php echo $ii; ?>','2',event)"
                           class="time_clock clockpicker current_index2<?php echo $ii; ?>"
...
//                        });
                ...
                <td style="color: red;">
                    <?php  if($holiday = $this->attendance_mod->search_holiday_1($value['date'])){
