                                            ...
                                            <div class="tab-pane p-20 active" role="tabpanel" id="personal_info_tab">
                                                <table  class="df col-md-12" style="margin-top: 10px;width: 1000px !important;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="hidden" name="emp_id" id="emp_id">
                                                            <input type="text" name="emp_no" id="emp_no" class="form-control" placeholder="Employee ID">
                                                            <span class="error-block"></span>
                                                        </th>
...
<!--                                                        </th>-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <select name="gender" id="gender" class="form-control nOselect2" >
                                                                <option value=""></option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="text" name="initials" id="initials" class="form-control" placeholder="Name With Initials">
                                                            <span class="error-block"></span>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="text" name="birthday" id="birthday" class="form-control date date-pick" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Birthday">
                                                            <span class="error-block"></span>
                                                        </th>
                                                        <th class="title_head">NIC No  <span style="color: red">*</span></th>
                                                        <th>
                                                            <input type="text" name="nic_num" id="nic_num" class="form-control" placeholder="NIC No">
                                                            <span class="error-block"></span>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="text" name="driving_license" id="driving_license" class="form-control" placeholder="Driving License No">
                                                            <span class="error-block"></span>
                                                        </th>
                                                        <th class="title_head">Other ID</th>
                                                        <th>
                                                            <input type="text" name="other_id" id="other_id" class="form-control" placeholder="Other ID">
                                                            <span class="error-block"></span>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <select name="blood_group" id="blood_group" class="form-control nOselect2">
                                                                <option value=""></option>
                                                        ...
                                                        <th>
                                                            <select name="religion" id="religion" class="form-control nOselect2">
                                                                <option value=""></option>
                                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <select name="nationality" id="nationality" class="form-control nOselect2">
                                                                <option value=""></option>
                                                                <?php
                                                        ...
                                                        <th>
                                                            <select name="marital_status" id="marital_status" class="form-control nOselect2">
                                                                <option value=""></option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <select name="finger_print" id="finger_print" class="form-control nOselect2">
                                                                <option value=""></option>
                                                        ...
                                                        <th>
                                                            <select name="report_active" id="report_active" class="form-control nOselect2">
                                                                <option value=""></option>
                                                                <option value="">Yes</option>
                                                                <option value="">No</option>
                                                            </select>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="text" name="left_date" id="left_date" class="form-control date date-pick" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Left Date">
                                                            <span class="error-block"></span>
                                                        </th>

                                                        <th class="title_head">Status</th>
                                                        <th>
                                                            <select name="emp_status" id="emp_status" class="form-control nOselect2">
                                                                <option value=""></option>
                                                                <option value="">Yes</option>
                                                                <option value="">No</option>
                                                            </select>
                                            ...
                                            <div class="tab-pane p-20" role="tabpanel" id="contact_info_tab">
                                                <table  class="df col-md-12" style="margin-top: 10px;width: 1000px !important;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="text" name="mobile_phone" id="mobile_phone" class="form-control" size="10" placeholder="Personal Mobile">
                                                            <span class="error-block"></span>
                                                        </th>
                                                        <th class="title_head">Mobile 2</th>
                                                        <th>
                                                            <input type="text" name="mobile_phone_2" id="mobile_phone_2" class="form-control" size="10" placeholder="Personal Mobile">
                                                            <span class="error-block"></span>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="text" name="home_phone" id="home_phone" class="form-control" size="10" placeholder="Home Phone">
                                                            <span class="error-block"></span>
                                                        </th>
                                                        <th class="title_head">Personal Email</th>
                                                        <th>
                                                            <input type="email" name="personal_email" id="personal_email" class="form-control" placeholder="Personal Email">
                                                            <span class="error-block"></span>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="text" size="10" name="office_phone" id="office_phone" class="form-control" placeholder="Office Phone">
                                                            <span class="error-block"></span>
                                                        </th>
                                                                                       <!--        Techpack~~only~~~code~~ELV002~~~~~-->
                                                                                                                <th class="title_head">Office Phone Max Limit</th>
                                                                                                                <th>
                                                                                                                    <input type="text" size="10" name="max_limit" id="max_limit" class="form-control" placeholder="Office Phone Max Limit">
                                                                                                                    <span class="error-block"></span>
                                                                                                                </th>
                                                                                   <!--         Techpack~~only~~~code~~-->
                                                        <th class="title_head">Office Email</th>
                                                        <th>
                                                            <input type="email" size="10" name="office_email" id="office_email" class="form-control" placeholder="Office Email">
                                                            <span class="error-block"></span>
                                                        </th>
                                                    </tr>
                                                    </tbody>
                                            ...
                                            <div class="tab-pane p-20" role="tabpanel" id="job_info_tab">
                                                <table  class="df col-md-12" style="margin-top: 10px;width: 1000px !important;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <select name="emp_category" id="emp_category" class="form-control nOselect2" >
                                                                <option value=" "></option>
                                                                <?php
                                                        ...
                                                        <th>
                                                            <select name="department" id="department" class="form-control nOselect2">
                                                                <option value=" "></option>
                                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <select name="job_title" id="job_title" class="form-control nOselect2">
                                                                <option value=" "></option>
                                                                <?php
                                                        ...
                                                        <th>
                                                            <select name="branch" id="branch" class="form-control nOselect2">
                                                                <option value=" "></option>
                                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <input type="text" name="joined_date" id="joined_date" class="form-control date date-pick" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Date Of Joined">
                                                            <span class="error-block"></span>
                                                        </th>
                                                        <th class="title_head">Date Of Confirmation</th>
                                                        <th>
                                                            <input type="text" name="confirmed_date" id="confirmed_date" class="form-control date date-pick" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Date Of Confirmation">
                                                            <span class="error-block"></span>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <select name="supervisor" id="supervisor" class="form-control nOselect2">
                                                                <option value=""></option>
                                                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <select name="leave_category" id="leave_category" class="form-control nOselect2" readonly>
                                                                <option value=" "></option>
                                                        ...
                                                        <th>
                                                            <input type="text" name="day_off" id="day_off" class="form-control" autocomplete="off" placeholder="Day Off" readonly>
                                                        </th>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <?php $groups=array('admin','payroll'); if ($this->ion_auth->in_group($groups)) { ?>
                                                <div class="tab-pane p-20" role="tabpanel" id="salary_info_tab">
                                                    <table  class="df col-md-12" style="margin-top: 10px;width: 1000px !important;">
                                                        ...
                                                        <tr>
                                                            <th>Basic Salary</th>
                                                            <th><input name="basic_salary" id="basic_salary" class="form-control" placeholder="Basic Salary" type="text" readonly></th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <select class="form-control" name="festival_bonus" id="festival_bonus">
                                                                    ...
                                                                    <option value="Full Salary Calculation">Full Salary Calculation</option>
                                                                </select>
                                                            </th>
<!--                                                            <th>Salary Advance Req. Amount</th>-->
<!--                                                            <th><input name="advance_amount" id="advance_amount" class="form-control" placeholder="Advance Amount" type="text"></th>-->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                <select class="form-control" name="payroll_cat" id="payroll_cat">
                                                                    <option></option>
    ...
    function edit_emp(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('[name="salary_advance_state"]').val(data.emp_info.salary_advance_state);
                $('[name="advance_amount"]').val(data.emp_info.advance_amount);
                $('[name="festival_bonus"]').val(data.emp_info.festival_bonus);
                $('[name="other_deduction"]').val(data.emp_info.other_deduction);
                $('[name="epf_eligibility"]').val(data.emp_info.epf_eligibility);
                $('[name="etf_eligibility"]').val(data.emp_info.etf_eligibility);
                $('[name="b_card_eligibility"]').val(data.emp_info.b_card_eligibility);
                $('[name="payee"]').val(data.emp_info.payee);
                $('[name="payee_releif"]').val(data.emp_info.payee_releif);
                $('[name="coin_balance"]').val(data.emp_info.coin_balance);
                $('[name="anniversary_bonus"]').val(data.emp_info.anniversary_bonus);
                $('[name="salary_hold"]').val(data.emp_info.salary_hold);
                $('[name="payroll_cat"]').val(data.emp_info.payroll_cat);
                $('[name="service_year"]').val(data.emp_info.service_year);
                $('[name="pay_slip_state"]').val(data.emp_info.pay_slip_state);
                $('[name="pay_slip_state"]').val(data.emp_info.pay_slip_state);
                $('[name="increment_state"]').val(data.emp_info.increment_state);
                $('[name="anni_bonus_state"]').val(data.emp_info.anni_bonus_state);
                $('[name="anni_gift_state"]').val(data.emp_info.anni_gift_state);
                $('[name="festival_bonus_state"]').val(data.emp_info.festival_bonus_state);
                $('[name="gratuity_rep_state"]').val(data.emp_info.gratuity_rep_state);
                $('[name="incometax"]').val(data.emp_info.incometax);
                $('[name="gross_up"]').val(data.emp_info.gross_up);
                $('[name="date_tax"]').val(data.emp_info.date_tax);
                ...
                if(data.emp_info.marital_status == 'Married'){
                    ...
                    if(data.marital.spouse_name!="undefined") {
                        ...
                        $('#marital_status_info').html('' +
                            ...
                            '<th>' +
                            '<input type="text" name="spouse_name" id="spouse_name" class="form-control" placeholder="Spouse Name" value="' + data.marital.spouse_name + '">' +
                            '<input type="text" name="child_name1" id="child_name1" class="form-control" placeholder="Child Name" value="' + data.marital.child_name1 + '">' +
                            '<input type="text" name="child_name2" id="child_name2" class="form-control" placeholder="Child Name" value="' + data.marital.child_name2 + '">' +
                            '</th>' +
                            '<th>Birthdays</th>' +
                            '<th>' +
                            '<input type="text" name="spouse_birthday" id="spouse_birthday" class="form-control date date-pickz" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Spouse Birthday" value="' + data.marital.spouse_birthday + '">' +
                            '<input type="text" name="child_birthday1" id="child_birthday1" class="form-control date date-pickz" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Child Birthday" value="' + data.marital.child_birthday1 + '">' +
                            '<input type="text" name="child_birthday2" id="child_birthday2" class="form-control date date-pickz" data-date-format="yyyy-mm-dd" autocomplete="off" placeholder="Child Birthday" value="' + data.marital.child_birthday2 + '">' +
                            '</th>' +
                            '<th>NICs</th>' +
                            '<th>' +
                            '<input type="text" name="spouse_nic" id="spouse_nic" class="form-control" placeholder="Spouse NIC" value="' + data.marital.spouse_nic + '">' +
                            '<input type="text" name="child_nic1" id="child_nic1" class="form-control" placeholder="Child NIC" value="' + data.marital.child_nic1 + '">' +
                            '<input type="text" name="child_nic2" id="child_nic2" class="form-control" placeholder="Child NIC" value="' + data.marital.child_nic2 + '">' +
                            '</th>' +
                            '');
                    }
...
//                    window.location = "<?php //echo base_url('systems/employee_list/index')?>//";
    ...
    function save(save_method)
    {
        ...
        var url = "<?php echo site_url('systems/employee_list/save_employee'); ?>/" + save_method;
        $.ajax({
            url: url,
            type: "POST",
