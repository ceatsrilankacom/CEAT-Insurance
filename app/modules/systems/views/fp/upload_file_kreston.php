...
<!--UPLOAD MODAL-->
<div class="modal fade" id="upload_file_kr"  data-backdrop="static" and data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
<script type="text/javascript">
    ...
    function upload_fp_data() {
        ...
        if (raw_upload_month != "") {
            ...
            var url = "<?php echo site_url('systems/file_upload_con/upload_file_kr'); ?>";
            $.ajax({
                url: url,
                cache: false,
                contentType: false,
