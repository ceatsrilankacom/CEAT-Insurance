...
<!--UPLOAD MODAL-->
<div class="modal fade" id="upload_file_tech"  data-backdrop="static" and data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="upload_file_tech_form" enctype='multipart/form-data' class="form-horizontal" role="form">
            ...
            <div class="modal-body">
                ...
                <div class="warp_form">
                    <p>
                        Support only csv, dat, txt file extensions <a href="<?php echo base_url(); ?>assets/data/fp_sample_software_export_new_tech.txt"  target="_blank" class="pull-right btn btn-sm btn-default">View Sample FP File</a>
                    </p>
...
<script type="text/javascript">
    ...
    function upload_fp_data() {
        ...
        if (raw_upload_month != "") {
            ...
            var url = "<?php echo site_url('systems/file_upload_con/upload_file_tech'); ?>";
            $.ajax({
                url: url,
                cache: false,
                contentType: false,
                ...
                success: function (data) {
                    ...
                    $('.warp_form').show();
                    $('#upload_file_tech_form')[0].reset();
                    if (data.status) {
                        bootbox.alert(data.message);
                        $('#upload_file_tech').modal('hide');
