<div  style="float: left;font-size: small;" >
    ...
    <div class="container1">
        ...
        <div class="col-lg-12"  id="print_btn_1">
            ...
            <h5>EPF REPORT : <?php echo $emp_type; ?> :: <?php echo $branch; ?> <?php echo ($dep_mod!=0)?' :: '.$dep_name:''; ?></h5>
 ...
 width:142pt" width="189">
                    ...
                    <tr style="height:16.5pt" height="22">
                        ...
                        <td class="xl86">&nbsp;</td>
                        <td class="xl86">&nbsp;</td>
                        <td class="xl87" colspan="2" style="mso-ignore:colspan">EMPLOYEES PROVIDENT FUND</td>
                        <td class="xl89">&nbsp;</td>
                        <td class="xl90">&nbsp;</td>
                        <td class="xl66"></td>
                        <td class="xl66"></td>
                    ...
                    <tr style="height:16.5pt" height="22">
                        ...
                        <td class="xl66"></td>
                        <td class="xl94" colspan="3" style="mso-ignore:colspan;border-right:1.0pt solid black"><span style="mso-spacerun:yes">&nbsp;</span>EPF Register Number:……………<span style="mso-spacerun:yes">&nbsp;</span></td>
                        <td class="xl66"></td>
                        <td class="xl66"></td>
                        <td class="xl66"></td>
                        <td class="xl66"></td>
            ...
            <table id="pay-sheet-one" class="pay-sheet"  style="font-size: 12px; 900px" border="1">
<!--               --><?php //if($emp_type_id=='1'){ ?>
                ...
                <tr class="c"><th class="w2"  style="text-align: center">#</th>
                    ...
                    <th class="w6" style="text-align: center">EPF (8%)</th>
                    <th class="w6" style="text-align: center">EPF (12%)</th>
                    <th class="w6" style="text-align: center">TOTAL EPF (20%)</th>
                </tr>
                </thead>
            <?php
            $counter = 1;
                   foreach ($sheet_data as $sheet => $data) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right"><?php echo
                                        number_format((float)($data['epf']+$data['epf12']), 2, '.', ','); ?></td>
                                </tr>
                       ...
                       $counter++;
                        ...
                        <tr class="total">
                            ...
                            <th><?php echo number_format(($totepf), 2, '.', ','); ?></th>
                        </tr>
                <!--//JE Add End-->
            </table>
...
<script>
    ...
    function word_generator() {
        ...
        var file_type_word = month_nw+'-EPF Sheet';
    ...
    function fnExcelReport() {
        ...
        var file_type = month_nw+'-EPF Sheet';
