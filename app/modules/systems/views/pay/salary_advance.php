    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Salary Advance Management</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="element-wrapper">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Salary Advance Management</h4>
                <button type="button" class="btn btn-success pull-right" onclick='add_new();' style="margin-right: 10px" ><i class="fa fa-plus-circle"></i> Add Salary Advance </button>
<!--                <button type="button" class="btn btn-success pull-right" onclick='add_new_type();' style="margin-right: 10px"><i class="fa fa-plus-circle"></i> Add Salary Advance Type</button>-->
            ...
            <div class="element-box">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" role="tab" href="#sal_adv" data-toggle="tab"> Salary Advances</a></li>
<!--                    <li class="nav-item"><a class="nav-link" role="tab" href="#all_types" data-toggle="tab">Salary Advance Types</a></li>-->
                </ul>

                <!-- Tab panes -->
                <div class="tab-content tabcontent-border">
                    <div class="tab-pane p-20 active" role="tabpanel" id="sal_adv">
                        <table id="salary_advance_datatable" class="table" cellspacing="0" width="100%">
