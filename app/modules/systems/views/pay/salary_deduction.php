...
<!--                    <li class="nav-item"><a class="nav-link active" role="tab" href="javascript:;" data-toggle="tab"> Salary Monthly deductions</a></li>-->
                    ...
                    <li class="nav-item"><a class="nav-link active" role="tab" href="#sal_pay" data-toggle="tab"> Salary Monthly deductions</a></li>
                    <li class="nav-item"><a class="nav-link" role="tab" href="#sal_pay_all" data-toggle="tab"> Salary Monthly deductions Detail</a></li>
                </ul>
                ...
                <div class="tab-content tabcontent-border">
                    ...
                    <div class="tab-pane p-20 " role="tabpanel" id="sal_pay_all">
                        <table id="salary_deduction_datatable_detail" class="table" cellspacing="0" width="100%">
                            <thead style="background-color: #912fa6;color: white;">
                            <tr>
                                <th>#</th>
                                <th>Deduction Name</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        salary_deduction_datatable_detail = $('#salary_deduction_datatable_detail').DataTable({
            "processing": true,
            "serverSide": true,
            ...
            "ajax": {
                ...
                "url": "<?php echo base_url()?>systems/salary_settings_con/get_deduction_data_detail",
                "type": "POST"
            },
        ...
        salary_deduction_datatable_detail.on('order.dt search.dt', function () {
            salary_deduction_datatable_detail.column(0, {search: 'applied', order: 'applied'}).nodes().each(function (cell, i) {
                cell.innerHTML = i + 1;
            });
        }).draw();


        yadcf.init(salary_deduction_datatable_detail, [{
                filter_type: "text",
                filter_delay: 100,
                column_number: 1
            },{
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    reload_table(salary_deduction_datatable_detail);
                }
                else {
                    if (data.message) {
    ...
    function delete_deduction_detail(id)
    {
        bootbox.dialog({
            message: "Are you sure, that you want to delete this Salary Monthly Employee Deduction record?",
            title: "Alert!",
            buttons: {
                ok: {
                    label: "Yes",
                    ...
                    callback: function () {
                        $.ajax({
                            url : "<?php echo base_url()?>systems/salary_settings_con/delete_deduction_detail",
                            type: "POST",
                            data: {
                                "deduction_id": id,
                                "<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"
