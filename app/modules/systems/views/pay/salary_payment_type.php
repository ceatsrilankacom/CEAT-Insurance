    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Salary Monthly Payments Types</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="element-wrapper">
            ...
            <div class="card-header bg-info page-head-title-wrap">
                <h4 class="page-head-title card-title  text-white" style="display: inline-block"> Salary Monthly Payments Types</h4>

                <button type="button" class="btn btn-success pull-right" onclick='add_new_type();' style="margin-right: 10px" ><i class="fa fa-plus-circle"></i> Add Salary Monthly Payment Type</button>
            </div>
            <div class="element-box">
                <!-- Nav tabs -->
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" role="tab" href="#all_types" data-toggle="tab">Salary Monthly Payment Types</a></li>
                </ul>
                ...
                <div class="tab-content tabcontent-border">
                    ...
                    <div class="tab-pane p-20 active" role="tabpanel" id="all_types">
                        <table id="salary_payment_types_datatable" class="table" cellspacing="0" width="100%">
...
<script type="text/javascript">
    ...
    function add_new()
    {
        ...
        $('#salary_payment_modal .modal-title').text('Add Salary Advance');
    }
    ...
    function edit_payment(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('#salary_payment_modal').modal({backdrop: 'static', keyboard: false});
                $('#salary_payment_modal .modal-title').text('Edit Advance : #' + data[0].id);
            },
            error: function ()
            {
